...
export async function loginService(user) {
  try {
      ...
      // Determinar ID dinámico según el rol del usuario
      const id = userFound.id_alumno || userFound.id_profesor || null;

      const payload = {
          id,                     // ID dinámico del usuario
          id_alumno: userFound.id_alumno || null,
          id_profesor: userFound.id_profesor || null,
          rut: userFound.rut,
          rol: userFound.rol,     // Rol del usuario (alumno/profesor/etc.)
      };
